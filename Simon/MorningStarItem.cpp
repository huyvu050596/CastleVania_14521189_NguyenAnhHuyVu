...
MorningStarItem::MorningStarItem(float x, float y)
{
	TypeItem = MORNINGSTAR_ITEM;
...
MorningStarItem::~MorningStarItem()
{
}

void MorningStarItem::Update(GameCamera *camera, int t)
{
